...
echo "🎨 Deploying Brahmastra Dashboard to EC2..."
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .large-chart { grid-column: 1 / -1; height: 400px; }
...
<body>
    <div class="container">
        ...
        <div class="card large-chart">
            <div class="card-title">Historical Metrics</div>
...
echo ""
echo "📊 The dashboard will show real-time metrics from your API!"
